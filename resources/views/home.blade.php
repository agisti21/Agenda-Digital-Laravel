...
<html lang="en">
  ...
  <div class="main-section">
        ...
        <a class="navbar-brand" href="memos">Notes</a>
        <a class="navbar-brand" href="schedules">Jadwal</a>
  			...
  			<div class="row description js-fullheight align-items-center justify-content-center">
  				<div class="col-md-8 text-center">
  					<div class="text">
  						...
  						<h4 class="mb-5 mt-2">Make your day </h4>
  						<div class="designed d-inline-block">
  							<d class="d-flex align-items-center">
                	<div class="ml-3"><p class="mb-0">Designed by: <span>Agisti Setia Putri</span></p></div>
  							</d>
  						</div>
  					</div>
  				</div>
